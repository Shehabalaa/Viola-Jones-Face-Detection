...
class Cascade(object):
    ...
    def read_prev_stages(self,path):
        try:
            for stage_file in os.listdir(path):
                ...
                print("Stages num {0} (fpr,dr) = {1}".format(len(self.stages),stage.fpr_dr))
    ...
    def predict(self,iis,feature_scale=1.0):
        """
        ...
        for stage in self.stages:
            result = stage.predict(iis[iis_indicies],feature_scale)
