...
def main():
    ...
    recs = [[recs[i][0][1],recs[i][0][0],recs[i][0][1]+recs[i][1][1],recs[i][0][0]+recs[i][1][0]] for i in range(len(recs))]
    [cv2.rectangle(gray,(rec[0],rec[1]),(rec[2],rec[3]), (255, 255, 0), 2) for rec in recs ]
