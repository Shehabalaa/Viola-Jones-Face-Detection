...
pos_train_iis=pickle.load(files[0])[0:2000]
neg_train_iis=pickle.load(files[1])[0:2000]
...
cascade.train(pos_train_iis,neg_train_iis,pos_valid_iis,neg_valid_iis,[.001,.99],min_feature_width, max_feature_width, min_feature_height, max_feature_height)
